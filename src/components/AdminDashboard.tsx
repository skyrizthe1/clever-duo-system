    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <div className="overflow-x-auto pb-4">
          <div className="flex gap-6 min-w-max lg:grid lg:grid-cols-2 xl:grid-cols-4 lg:min-w-0">
            <Card 
              className="cursor-pointer hover:bg-gradient-to-br hover:from-blue-50 hover:to-blue-100 transition-all duration-300 hover:scale-105 hover:shadow-xl shadow-lg bg-white/90 backdrop-blur-sm border-2 border-gray-200 hover:border-blue-300 min-w-[280px] lg:min-w-0"
            ...
            <Card 
              className="cursor-pointer hover:bg-gradient-to-br hover:from-green-50 hover:to-green-100 transition-all duration-300 hover:scale-105 hover:shadow-xl shadow-lg bg-white/90 backdrop-blur-sm border-2 border-gray-200 hover:border-green-300 min-w-[280px] lg:min-w-0"
            ...
            <Card 
              className="cursor-pointer hover:bg-gradient-to-br hover:from-purple-50 hover:to-purple-100 transition-all duration-300 hover:scale-105 hover:shadow-xl shadow-lg bg-white/90 backdrop-blur-sm border-2 border-gray-200 hover:border-purple-300 min-w-[280px] lg:min-w-0"
            ...
            <Card 
              className="cursor-pointer hover:bg-gradient-to-br hover:from-orange-50 hover:to-orange-100 transition-all duration-300 hover:scale-105 hover:shadow-xl shadow-lg bg-white/90 backdrop-blur-sm border-2 border-gray-200 hover:border-orange-300 min-w-[280px] lg:min-w-0"
